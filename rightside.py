...
class SensorDisplay(QWidget):
    ...
    def initUI(self):
        ...
        self.roll_value_label = QLabel('00.00'+ u'\u00b0', self)

        self.pitch_label = QLabel('Pitch:', self)
        self.pitch_value_label = QLabel('00.00'+ u'\u00b0', self)

        self.yaw_label = QLabel('Yaw:', self)
        self.yaw_value_label = QLabel('00.00'+ u'\u00b0', self)
        ...
        self.speed_value_label = QLabel('0 m/s', self)
        ...
        hori_layout_4.addLayout(mode_layout)
